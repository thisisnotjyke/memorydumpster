                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="post" action="{{ isset($post) ? route('posts.update', $post->id) : route('posts.store') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
                        ...
                        <div>
                            ...
                            <x-text-input id="title" name="title" type="text" class="mt-1 block w-full" :value="isset($post) ? $post->title : old('title')" required autofocus />
                        ...
                        <div>
                            ...
                            <textarea id="content" name="content" class="mt-1 block w-full" required autofocus>{{ isset($post) ? $post->content : old('content') }}</textarea>
